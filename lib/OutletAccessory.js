...
class OutletAccessory {
    ...
    constructor(...props) {
        ...
        scanner.on('discover', device => {
            ...
            this.platform.log('[SwitchmateBLE:Outlet] Found %s', this.device.id);
    ...
    connect(callback) {
        ...
        this.platform.log('[SwitchmateBLE:Outlet] Connecting to %s', this.device.id);
        ...
        async.series({
            ...
            Instrumentation: next => {
                ...
                this.platform.log('[SwitchmateBLE:Outlet] Connected to %s', this.device.id);
